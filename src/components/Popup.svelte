<script lang="ts">
	...
	import { addBookmark, appDataStore, setAppData, getAppData } from '$lib/storage';
  ...
  import type { DateValue } from "@internationalized/date";
	...
	let syncStatus = $state<'synced' | 'syncing' | 'error' | 'idle'>('idle');
	...
	async function handleRestore() {
		...
		try {
			...
			if (data) {
				...
				// The store will auto-update, no need to manually reload the component
				syncStatus = 'synced';
