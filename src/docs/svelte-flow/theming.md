...
- (source: https://svelteflow.dev/learn/guides/theming)
...
For a complete example of using Tailwind with Svelte Flow, check out the [tailwind example](https://svelteflow.dev/examples/styling/tailwind)!